...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'css', 'lua', 'python', 'html', 'java', 'json', 'php', 'tsx', 'typescript', 'vimdoc',
    'vim', 'javascript', 'bash' },
...
require("mason-null-ls").setup({
  ensure_installed = { 'prettierd', 'eslint_d', 'google_java_format','rustfmt' },
  automatic_installation = true
})
...
vim.keymap.set("n", "<M-4>","4gt",{noremap=true,silent=true})
vim.keymap.set("n", "<M-5>","5gt",{noremap=true,silent=true})
vim.keymap.set("n", "<M-6>","6gt",{noremap=true,silent=true})
